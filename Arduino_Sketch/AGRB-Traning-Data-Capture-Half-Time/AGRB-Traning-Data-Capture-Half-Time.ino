...
Description: Upon button press, send 3 seconds of data reads over serial. Long Press initiates stream of data sent. 380 points, with one second between streams. It will be recieved by Capture Data.py, Predict Gesture.py, and Predict Gesture Twitch.py
...
void loop() {
  ...
  if(currTime-startTime <= 2000 && id < datapoints){
    //Serial.print(id);
    //Serial.print(',');
